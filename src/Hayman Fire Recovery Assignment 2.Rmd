...
print("There is a positive correlation between NDMI and NDVI for the summer months")
...
ggplot(all_year, aes(x=mean_ndsi, y=mean_ndvi))+ 
  ...
  scale_color_few() + 
  theme(legend.position=c(0.8,0.8))
print("There is a weak positive correlation between NSDI and NDVI")
...
ggplot(all_year3, aes(x=mean_ndsi, y=mean_ndvi, color=site))+ 
  ...
  theme_few() + 
  scale_color_few()
message("The burned sites are more impacted by the previous years snow than the unburned sites")
```
## Question 4
